      ...
      <main className="py-12">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-12">
            <h1 className="text-4xl md:text-5xl font-bold text-gray-800 mb-6">Let's Talk About Your Roof</h1>
            <p className="text-lg text-gray-600 max-w-4xl mx-auto">
              Have questions about roofing, solar, or your next home project? Our team is here to help. Whether you're
              ready for a free estimate or just exploring your options, we'll guide you with clear answers, honest
